...
let test_m_negative_0 () =
  Alcotest.check_raises "m_negative: M < 0 should raise Invalid_argument"
    ...
    (fun () ->
      ignore (Window.cosine_sum ~fftbins:false Nx.float32 [|1.0|] (-1)) )

let test_m_zero_f32_1 () =
  let expected = Nx.zeros Nx.float32 [|0|] in
  let actual = Window.cosine_sum ~fftbins:false Nx.float32 [|1.0|] 0 in
  Alcotest.check f32_nx_testable "m_zero_f32: M = 0, empty array" expected
    actual

let test_m_zero_f64_2 () =
  let expected = Nx.zeros Nx.float64 [|0|] in
  let actual = Window.cosine_sum ~fftbins:true Nx.float64 [||] 0 in
  Alcotest.check f64_nx_testable "m_zero_f64: M = 0, empty array" expected
    actual

let test_m_one_f32_3 () =
  let expected = Nx.ones Nx.float32 [|1|] in
  let actual = Window.cosine_sum ~fftbins:false Nx.float32 [|1.0|] 1 in
  Alcotest.check f32_nx_testable "m_one_f32: M = 1, ones array" expected actual

let test_m_one_f64_varied_coeffs_4 () =
  let expected = Nx.ones Nx.float64 [|1|] in
  let actual = Window.cosine_sum ~fftbins:true Nx.float64 [|0.5; 0.5|] 1 in
...
let test_sym_m5_a1_f32_5 () =
  let expected_values =
    [| 1.00000000e+00
     ...
     ; 1.00000000e+00 |]
  in
  let expected = Nx.create Nx.float32 [|5|] expected_values in
  let actual = Window.cosine_sum ~fftbins:false Nx.float32 [|1.0|] 5 in
...
let test_sym_m10_a_half_half_f64_6 () =
  let expected_values =
    [| 0.00000000e+00
     ...
     ; 0.00000000e+00 |]
  in
  let expected = Nx.create Nx.float64 [|10|] expected_values in
  let actual = Window.cosine_sum ~fftbins:false Nx.float64 [|0.5; 0.5|] 10 in
...
let test_sym_m8_a_hamm_like_f32_7 () =
  let expected_values =
    [| 7.99999982e-02
     ...
     ; 7.99999982e-02 |]
  in
  let expected = Nx.create Nx.float32 [|8|] expected_values in
  let actual = Window.cosine_sum ~fftbins:false Nx.float32 [|0.54; 0.46|] 8 in
  Alcotest.check f32_nx_testable
...
let test_sym_m7_a_multi_f64_8 () =
  let expected_values =
    [| 8.50000000e-01
     ...
     ; 8.50000000e-01 |]
  in
  let expected = Nx.create Nx.float64 [|7|] expected_values in
  let actual =
    Window.cosine_sum ~fftbins:false Nx.float64 [|1.0; 0.2; 0.05|] 7
  in
  Alcotest.check f64_nx_testable
...
let test_sym_m6_a_empty_f32_9 () =
  let expected_values =
    [| 0.00000000e+00
     ...
     ; 0.00000000e+00 |]
  in
  let expected = Nx.create Nx.float32 [|6|] expected_values in
  let actual = Window.cosine_sum ~fftbins:false Nx.float32 [||] 6 in
  Alcotest.check f32_nx_testable
...
let test_per_m5_a1_f32_10 () =
  ...
  in
  let expected = Nx.create Nx.float32 [|5|] expected_values in
  let actual = Window.cosine_sum ~fftbins:true Nx.float32 [|1.0|] 5 in
  Alcotest.check f32_nx_testable
...
let test_per_m10_a_half_half_f64_11 () =
  ...
  in
  let expected = Nx.create Nx.float64 [|10|] expected_values in
  let actual = Window.cosine_sum ~fftbins:true Nx.float64 [|0.5; 0.5|] 10 in
  Alcotest.check f64_nx_testable
...
let test_per_m8_a_hamm_like_f32_12 () =
  ...
  in
  let expected = Nx.create Nx.float32 [|8|] expected_values in
  let actual = Window.cosine_sum ~fftbins:true Nx.float32 [|0.54; 0.46|] 8 in
  Alcotest.check f32_nx_testable
...
let test_per_m7_a_multi_f64_13 () =
  ...
  let expected = Nx.create Nx.float64 [|7|] expected_values in
  let actual =
    Window.cosine_sum ~fftbins:true Nx.float64 [|1.0; 0.2; 0.05|] 7
  in
  Alcotest.check f64_nx_testable
...
let test_per_m6_a_empty_f64_14 () =
  let expected_values =
    [| 0.00000000e+00
     ...
     ; 0.00000000e+00 |]
  in
  let expected = Nx.create Nx.float64 [|6|] expected_values in
  let actual = Window.cosine_sum ~fftbins:true Nx.float64 [||] 6 in
  Alcotest.check f64_nx_testable
...
let test_sym_m64_a_rect_plus_cosine_f32_15 () =
  let expected_values =
    [| 6.99999988e-01
     ...
     ; 6.99999988e-01 |]
  in
  let expected = Nx.create Nx.float32 [|64|] expected_values in
  let actual = Window.cosine_sum ~fftbins:false Nx.float32 [|1.0; 0.3|] 64 in
  Alcotest.check f32_nx_testable
...
let test_per_m64_a_rect_plus_cosine_f64_16 () =
  let expected_values =
    [| 7.00000000e-01
     ...
     ; 7.01444582e-01 |]
  in
  let expected = Nx.create Nx.float64 [|64|] expected_values in
  let actual = Window.cosine_sum ~fftbins:true Nx.float64 [|1.0; 0.3|] 64 in
  Alcotest.check f64_nx_testable
...
let test_sym_m5_a_one_zero_f32_17 () =
  ...
  let expected = Nx.create Nx.float32 [|5|] expected_values in
  let actual =
    Window.cosine_sum ~fftbins:false Nx.float32 [|1.0; 0.0; 0.5|] 5
  in
  Alcotest.check f32_nx_testable
